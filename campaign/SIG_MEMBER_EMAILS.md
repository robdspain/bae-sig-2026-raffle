# BAE SIG Member Emails — Daily Speaker Spotlight Series
Generated: 2026-02-24
Goal: Drive ticket sales to SIG members with daily donor spotlights
Raffle site: https://calaba-sig-raffle.vercel.app
Drawing: CalABA Friday Reception — March 7, 2026

---

## Email 1 — Day 1 Launch + Spotlight: Dr. Peter Killeen
**Send date:** Feb 24 (today)
...
He's donated a **1-hour private Zoom consultation** (valued at $200+).
That's one hour with one of the brightest minds in behavior analysis — yours to use however you'd like: your research, a tough case, data analysis, philosophy of science. Whatever you need.
...
## Email 2 — Spotlight: Mellanie Page (OBM Practitioner Program)
**Send date:** Feb 25
...
## Email 3 — Spotlight: Portia C. James (Book + Mentor Session)
**Send date:** Feb 26
...
## Email 4 — Spotlight: Caroly Shumway (ABA Climate Coalition CEU)
**Send date:** Feb 27
...
## Email 5 — Spotlight: Reginald Ponio / BABAC (Essential for Living Manuals)
**Send date:** Feb 28
...
## Email 6 — Spotlight: Rob Spain / BehaviorSchool (6-Month Subscription) + Final Push
**Send date:** March 1
...
## Email 7 — Final Urgency (Optional)
**Send date:** March 4 or March 5
...
## Notes
- Replace [First Name] with mail merge or first name from list
- Use gog CLI to send once approved: `gog send --from california.bae.sig@gmail.com --csv members.csv`
- Need SIG member email list (separate from speaker list)
